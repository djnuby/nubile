import base64  # Aggiungi questa linea
import pandas as pd
...
def analyze_data(df, filename):
    ...
    b64 = base64.b64encode(csv.encode()).decode()  # alcuni byte magici
...
st.title("ClAster Forecaster, analizza il tuo cluster in un istante")
...
if uploaded_file is not None:
    ...
    analyze_data(df, uploaded_file.name)
